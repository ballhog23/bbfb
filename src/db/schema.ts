...
export const leagueUsersTable = pgTable(
    "league_users",
    {
        userId: text()
    ...
    (table) => [
        primaryKey({
            name: "league_user_identity",
            columns: [table.userId, table.leagueId],
        }),
    ]
);
...
export const matchupsTable = pgTable(
    "matchups",
    {
        leagueId: text().notNull(),
        season: text().notNull(),
...
export const matchupOutcomesTable = pgTable(
    "matchup_outcomes",
    {
        leagueId: text().notNull(),
        matchupId: integer(),
        ...
        rosterOwnerId: text()
            .references(() => sleeperUsersTable.userId)
            .notNull(), // this references rostersTable.ownerId
...
export const playoffsTable = pgTable(
    "playoff_bracket_matchups",
    {
        leagueId: text()
            .references(() => leaguesTable.leagueId)
            .notNull(),
...
export const leagueStateTable = pgTable(
    "league_state",
    {
