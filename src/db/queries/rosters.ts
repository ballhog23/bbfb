...
import { rostersTable, type InsertRoster } from '../schema.js';
import { RosterParams } from "../../api/rosters.js";
...
export async function insertAllLeagueRosters(leagueRosters: InsertRoster[]) {
