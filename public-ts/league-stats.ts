...
const leagueSelect = document.querySelector<HTMLSelectElement>(
    "#stats-league-select"
)!;
const leagueSelectWrapper = document.querySelector<HTMLElement>(
...
async function loadAllTimeStats() {
    try {
        ...
        content.innerHTML =
            '<p class="stats-error">Failed to load stats data.</p>';
    }
}
...
async function loadSeasonStats(leagueId: string) {
    try {
        ...
        content.innerHTML =
            '<p class="stats-error">Failed to load season stats.</p>';
    }
}
...
function svgIcon(name: string) {
    const icons: Record<string, string> = {
        ...
        "trending-up":
            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',
        "trending-down":
            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="22 17 13.5 8.5 8.5 13.5 2 7"/><polyline points="16 17 22 17 22 11"/></svg>',
...
function renderAllTimeStats(s: StatsData): string {
    ...
    return [
        renderSection(
            "trophy",
            "The Big Numbers",
            "The all-time ledger of fantasy dominance",
            [
                {
        ...
        renderSection(
            "flame",
            "Scoring Records",
            'The all-time highs, lows, and "how did that happen?" moments',
            [
                {
        ...
        renderSection(
            "zap",
            "Point Margins",
            "Every blowout and nail-biter across league history",
            [
                {
        ...
        renderSection(
            "flame",
            "The Streaks",
            "The longest runs of glory and despair in league history",
            [
                {
        ...
        renderSection(
            ...
            "The legends atop the all-time mountain",
            [
                {
        ...
        renderSection(
            "skull",
            "That's Gotta Hurt",
            "The universe has had a sick sense of humor since day one",
            [
                {
...
function renderSeasonStats(s: StatsData, season: string): string {
    ...
    return [
        renderSection(
            "trophy",
            "The Big Numbers",
            `The ${season} season by the numbers`,
            [
                {
                    title: "Total Points Scored",
                    icon: "target",
        ...
        renderSection(
            "flame",
            "Scoring Records",
            `The highs and lows of the ${season} season`,
            [
                {
                    title: "Most Points in a Game",
                    icon: "trending-up",
        ...
        renderSection(
            "zap",
            "Point Margins",
            `Blowouts and nail-biters of the ${season} season`,
            [
                {
                    title: "Largest Margin of Victory",
                    icon: "zap",
        ...
        renderSection(
            "flame",
            "The Streaks",
            `The longest runs of the ${season} season`,
            [
                {
                    title: "Longest Winning Streak",
                    icon: "trending-up",
        ...
        renderSection(
            "skull",
            "That's Gotta Hurt",
            `The ${season} season was not kind to everyone`,
            [
                {
                    title: "Most Points in a Loss",
                    icon: "skull",
